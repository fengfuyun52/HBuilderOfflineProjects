 ...
 */
w.clicked=function(id,wa,ns,param){
	...
	if(w.plus){
		...
		openw=plus.webview.create(pre+id,id,{zindex: 9999,scrollIndicator:'none',scalable:false},param);
...
w.openDoc=function(t,c){
	...
	if(d){
		...
		d=plus.webview.create('/modules/doc.html','document',{zindex:9999,popGesture:'hide'},{preate:true});
