...
//				Rows.push(jsonData.data.Rows[i].Rows[j].name);
			...
			html = 		'<label class = "mui-media mui-input-row mui-checkbox mui-left">'
					...
					+			'<span class="clientspan" id='+ i +'>' + jsonData.data.Rows[i].name + '</span>'	
...
//			mui.fire(plus.webview.currentWebview().opener(), 'selectClient', {
//				
//			})
			mui.back();
//			// 页面跳转到详细
//			mui.openWindow({
//				url : "../fahuonew_delivery.html",
//			    //id:new-page-id,
////				    styles:{
